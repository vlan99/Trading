...
int start()
{
    if(StringFind(Symbol(),"CORN",0)>=0 || StringFind(Symbol(),"SOYBN",0)>=0 || StringFind(Symbol(),"WHEAT",0)>=0) return(0);
...
//----
    ...
    for(int i=0; i<OrdersTotal(); i++) 
    {
        ...
        if (StringFind(OrderSymbol(),"CORN",0)<0 && StringFind(OrderSymbol(),"WHEAT",0)<0 && StringFind(OrderSymbol(),"SOYBN",0)<0)
        {
    ...
    for(i=1; i<=240; i++) 
    {
        SwingRange_MN1 += (iHigh(NULL,PERIOD_MN1,i) - iLow(NULL,PERIOD_MN1,i)) / Point / MicroLotUnit;
        SwingRange_W1 += (iHigh(NULL, PERIOD_W1, i) - iLow(NULL, PERIOD_W1, i)) / Point / MicroLotUnit;
        SwingRange_D1 += (iHigh(NULL, PERIOD_D1, i) - iLow(NULL, PERIOD_D1, i)) / Point / MicroLotUnit;
        SwingRange_H4 += (iHigh(NULL, PERIOD_H4, i) - iLow(NULL, PERIOD_H4, i)) / Point / MicroLotUnit;
        SwingRange_H1 += (iHigh(NULL, PERIOD_H1, i) - iLow(NULL, PERIOD_H1, i)) / Point / MicroLotUnit;
        SwingRange_M30 += (iHigh(NULL, PERIOD_M30, i) - iLow(NULL, PERIOD_M30, i)) / Point / MicroLotUnit;
        SwingRange_M15 += (iHigh(NULL, PERIOD_M15, i) - iLow(NULL, PERIOD_M15, i)) / Point / MicroLotUnit;
        SwingRange_M5 += (iHigh(NULL, PERIOD_M5, i) - iLow(NULL, PERIOD_M5, i)) / Point / MicroLotUnit;
        SwingRange_M1 += (iHigh(NULL, PERIOD_M1, i) - iLow(NULL, PERIOD_M1, i)) / Point / MicroLotUnit;
